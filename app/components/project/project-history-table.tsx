...
// Define columns for our Project table
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem
              onClick={() => alert(`View project details for: ${project.id}`)}
            >
              View Details
            </DropdownMenuItem>
          </DropdownMenuContent>
...
export function ProjectHistoryTableFirebase() {
    ...
    async function fetchProjects() {
      try {
        ...
        querySnapshot.forEach((doc) => {
          // Assume each document has fields: registrationNumber, typeOfWork, location, date
...
export default ProjectHistoryTableFirebase;
